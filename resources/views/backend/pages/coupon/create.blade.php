    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-end">
                <a href="{{ route('coupon.index') }}" class="btn btn-primary"><i class="fas fa-plus-circle">Back tO Coupon</i></a>
            </div>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('coupon.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="discount_amount" class="form-control @error('discount_amount')
                      is_invalid
                    @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="minimum_purchase_amount" class="form-control @error('minimum_purchase_amount')
                    is_invalid
                    @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="validity_date" class="form-control @error('validity_date')
                    is_invalid
                    @enderror">
                    @error('minimum_purchase_amount')
                    <span class="invalid-feedback" role="alert">
