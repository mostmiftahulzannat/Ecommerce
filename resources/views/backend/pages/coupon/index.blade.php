    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-end">
                <a href="{{ route('coupon.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"> Add New
                        Coupon</i></a>
            </div>
        </div>

        <div class="row-12">
            <div class="table-responisve my-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('coupon.edit',$coupon->id) }}">
