                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <ul class="d-flex header-contact">
                            <li><i class="fa fa-phone"></i>01571715150</li>
                            <li><i class="fa fa-envelope"></i>zannat@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-12">
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    @php
                                        ...
                                        <li class="cart-items">
                                            ...
                                            <div class="cart-img">
                                                <img src="{{ asset('uploads/product') }}/{{ $cart->options->product_image }}" alt="">
                                            </div>
                                            <div class="cart-content">
                                                <a href="{{ route('cart.page') }}">{{ $cart->name }}</a>
                                                <span>QTY :{{$cart->qty}}</span>
                                                <p>${{ $cart->price }}</p>
                                                <td class="remove"><a href="{{ route('removeto-cart',['cart_id' =>$cart->rowId]) }}"><i class="fa fa-times"></i></a></td>
                                            </div>
                                        </li>
                                        @endforeach
                                    {{-- <li>Subtotol: <span class="pull-right">{{$cart->price * $cart->qty }}</span></li> --}}
                                    <li>
                                        <button>Check Out</button>
                                    </li>
                                </ul>
