...
@include('frontend.pages.widgets.bread', ['pagename' => $product->product_name])
            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{ asset('uploads/product') }}/{{ $product->product_image }}" alt="" class="figure-img img-fluid rounded">
                        </div>

                        @foreach($product->ProductImages as $image)
                            <div class="item">
                                <img src="{{ asset('uploads/product') }}/{{ $image->product_multiple_image }}"
                                     alt="">
                            </div>
                        @endforeach
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="featured-product-wrap">
                            <div class="featured-product-img">
                                <img src="{{ asset('uploads/product') }}/{{ $r_product->product_image }}" alt="img">
                            </div>
                            <div class="featured-product-content">
                                <div class="row">
                                    <div class="col-7">
                                        <h3>
                                            <a href="{{ route('productdetail.page',['product_slug' => $r_product->slug]) }}">{{ $r_product->product_name }}</a>
                                        </h3>
